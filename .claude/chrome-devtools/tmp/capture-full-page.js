...
async function run() {
  ...
  await page.screenshot({
    path: '/Users/bachasia/Working/VibeCoding/vibephim/.claude/chrome-devtools/screenshots/debug-full.png',
    fullPage: true,
  })

  // Top viewport only
  await page.screenshot({
    path: '/Users/bachasia/Working/VibeCoding/vibephim/.claude/chrome-devtools/screenshots/debug-top.png',
    clip: { x: 0, y: 0, width: 1440, height: 900 },
  })

  // Hero-to-carousel transition zone (y 600-1000)
  await page.screenshot({
    path: '/Users/bachasia/Working/VibeCoding/vibephim/.claude/chrome-devtools/screenshots/debug-transition.png',
